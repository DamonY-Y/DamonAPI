...
import com.damon.damonapi.back.common.*;
import com.damon.damonapi.back.constant.CommonConstant;
import com.damon.damonapi.back.constant.UserConstant;
import com.damon.damonapi.back.exception.BusinessException;
import com.damon.damonapi.back.model.dto.interfaceInfo.InterfaceInfoAddRequest;
import com.damon.damonapi.back.model.dto.interfaceInfo.InterfaceInfoInvokeRequest;
import com.damon.damonapi.back.model.dto.interfaceInfo.InterfaceInfoQueryRequest;
import com.damon.damonapi.back.model.dto.interfaceInfo.InterfaceInfoUpdateRequest;
import com.damon.damonapi.back.model.enums.InterfaceInfoStatusEnum;
...
//        // 仅本人或管理员可修改
    ...
    public BaseResponse<Object> invokeInterfaceInfo(@RequestBody InterfaceInfoInvokeRequest interfaceInfoInvokeRequest,
        ...
        DamonAPIClient tempClient = new DamonAPIClient(accessKey, secretKey);

        // todo： 针对不同的接口，使用不同的SDK进行请求和结果返回

        Gson gson = new Gson();
        SDG sdg = gson.fromJson(userRequestParams, SDG.class);
//        Dog dog = gson.fromJson(userRequestParams, Dog.class);
//        String usernameByPost = tempClient.getUsernameByPost(user);
        System.out.println(userRequestParams);

        String res = tempClient.getSDG(sdg);
//        String res = tempClient.getDogNameByPost(dog);
